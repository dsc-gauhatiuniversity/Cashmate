...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">Gauhati University</a>
      <span class="navbar-text">75 Glorious Years of Existence</span>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item"><a href="courses.php" class="nav-link">Available Courses</a></li>
          <?php 
              session_start();   
          ...
          ?> 
          <li class="nav-item custom-nav-item"><a href="#Feedback" class="nav-link">About Us</a></li>
          <li class="nav-item custom-nav-item"><a href="#Contact" class="nav-link">Connect with us</a></li>
        </ul>
      </div>
    </nav> <!-- End Navigation -->